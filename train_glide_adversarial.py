...
from glide_finetune.glide_finetune_adversarial import run_glide_finetune_epoch
from glide_finetune.Discriminator import Discriminator
...
def run_glide_finetune(
    ...
    use_fp16=True, # let's try to make this more efficient
    device="cpu",
    ...
    print("ACTUAL BATCH SIZE: ", batch_size)
    ...
    # Discriminator model & optimizer setup
    ngpu = 1
    ...
    lr = 0.0002
    beta1 = 0.5
    D_optimizer = th.optim.Adam(D_model.parameters(), lr=lr, betas=(beta1, 0.999))
    D_criterion = nn.BCELoss()

    # Also save checkpoints of discriminator model
    ...
    # Training setup
    print("TOTAL EPOCHS TO GET THROUGH: ", num_epochs)
    outputs_dir = "./outputs"
    ...
    for epoch in trange(num_epochs):
        ...
        run_glide_finetune_epoch(
            ...
            optimizer=optimizer, # glide optimizer
...
def parse_args():
    ...
    parser.add_argument("--batch_size", "-bs", type=int, default=1) # used to be 1
    ...
    parser.add_argument("--epochs", "-epochs", type=int, default=2) # changed to 2 epochs finetuning
    parser.add_argument(
        "--test_prompt",
        "-prompt",
        type=str,
